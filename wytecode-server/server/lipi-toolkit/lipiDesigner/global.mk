...
LIPIIDE_BIN=$(LIPI_ROOT)/lipiDesigner/bin
LIPIIDE_DOC=$(LIPI_ROOT)/lipiDesigner/doc
LIPIIDE_LIB=$(LIPI_ROOT)/lipiDesigner/lib
LIPIIDE_PACK=$(LIPI_ROOT)/lipiDesigner/package
LIPIIDE_PROJ=$(LIPI_ROOT)/lipiDesigner/projects
LIPIIDE_SCRIPT=$(LIPI_ROOT)/lipiDesigner/scripts
LIPIIDE_SRC=$(LIPI_ROOT)/lipiDesigner/src
